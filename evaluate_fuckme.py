...
def evaluate(model, dataset,
    ...
    with tf.Graph().as_default() as g:
        ...
        try:
            ...
            # plt.figure()
            plot_confusion_matrix(conf_mat, classes=CIFAR10_LABELS_LIST, normalize=False, title='{} - Accuracy: {}'.format(FLAGS.model_name, total_top1))
            print(conf_mat)
            print(total_top1)
            bar.finish()
...
def plot_confusion_matrix(cm, classes,
    ...
    fig.savefig('./conf_mat/' + FLAGS.checkpoint_dir.split('/')[-1] + '_conf_mat.png')
