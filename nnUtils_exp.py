...
def BinarizedSpatialConvolution(nOutputPlane, kW, kH, dW=1, dH=1,
        padding='VALID', bias=True, reuse=None, clip_limit = 1, name='BinarizedSpatialConvolution'):
...
def BinarizedAffine(nOutputPlane, bias=True, name=None, reuse=None, clip_limit=1):
